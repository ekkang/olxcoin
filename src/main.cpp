...
#if defined(NDEBUG)
# error "Olxcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x00449e984a40a189c6ab47987ced1bb8f075dffb841a46d068432a3e78aea490");
...
const string strMessageMagic = "Olxcoin Signed Message:\n";
...
{
    // Olxcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Olxcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Olxcoin: 3.5 days
static const int64 nTargetSpacing = 1 * 60; // Olxcoin: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Olxcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Olxcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8cf2d29d305151742f894ad6905824183eccd960ec30d328e436bfb893908157");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045a8125caf076d9e2396a8a36143db9b07ac5064b1a6df342fb184f8f82b1684da3403cbcb0be3b88c24f309d4f16c2022c0fa273d16c8df0a68d940eb9e788b7") << OP_CHECKSIG;
        CBlock block;
        ...
        block.nNonce   = 2086864559;

        if (fTestNet)
        {
            block.nTime    = 1545271566;
            block.nNonce   = 385333988;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x09a4eb5c97e1a0a7abe7e971151d57da24cd08afc3e1b54ea826bff48520b229"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xba, 0xd3 }; // Olxcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OlxcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OlxcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static OlxcoinMiner(CWallet *pwallet)
{
    printf("OlxcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("olxcoin-miner");
    ...
    try { loop {
        ...
        printf("Running OlxcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("OlxcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&OlxcoinMiner, pwallet));
}
